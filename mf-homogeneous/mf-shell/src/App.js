        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-3">
            ...
            <div className="flex flex-col">
              <span className="text-lg font-semibold text-gray-900">Homogeneous Microfrontends</span>
                ...
                <Route path="/" element={
                  <div>
                    <div className="mb-8">
                      ...
                      <p className="text-gray-600">Discover our curated collection via React microfrontends</p>
                    </div>
                    <ProductList />
                  </div>
                } />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0">
              ...
              <div className="text-sm text-gray-500 text-center md:text-right">
                ...
                <div>Homogeneous Microfrontend Architecture</div>
                <div className="text-xs mt-1">React Shell + React Remotes</div>
              </div>
            </div>
          </div>
        </footer>
